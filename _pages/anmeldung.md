    ...
    <select id="kurs" name="Kurs" required>
      ...
      {%- for course in site.data.trainings.courses -%}
        {%- for d in course.dates -%}
          ...
          {%- capture creditlabel -%}{% include credits-label.html credits=course.credit_points lang="de" %}{%- endcapture -%}
          {%- assign creditlabel = creditlabel | strip -%}
          {%- capture pricelabel -%}{% include price-label.html price=d.price lang="de" %}{%- endcapture -%}
